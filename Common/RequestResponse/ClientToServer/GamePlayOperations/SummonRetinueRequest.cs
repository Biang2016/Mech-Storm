...
public class SummonRetinueRequest : ClientRequestBase
{
    ...
    public SummonRetinueRequest(int clientId, int handCardInstanceId, int battleGroundIndex,  int targetRetinueId, bool isTargetRetinueIdTempId, int clientRetinueTempId) : base(clientId)
    {
