...
public abstract class ModuleBase : MonoBehaviour, IGameObjectPool, IDragComponent, IMouseHoverComponent
{
    ...
    internal CardInfo_Base ModuleCurrentCardInfo; //模块目前状态转卡牌信息
    ...
    public void DragComponent_OnMousePressed(BoardAreaTypes boardAreaType, List<SlotAnchor> slotAnchors, ModuleRetinue moduleRetinue)
    {
    ...
    public void DragComponent_SetHasTarget(ref bool hasTarget)
    {
        hasTarget = true;
    }
