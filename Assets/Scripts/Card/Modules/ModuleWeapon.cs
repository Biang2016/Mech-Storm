...
public class ModuleWeapon : ModuleBase {
    ...
    {
        ModuleCurrentCardInfo = new CardInfo_Weapon(CardInfo.CardID, CardInfo.CardName, CardInfo.CardDesc, CardInfo.Cost, CardInfo.HasTarget, CardInfo.CardType, M_WeaponEnergy, M_WeaponEnergyMax, M_WeaponAttack, M_WeaponType);
