...
internal class ServerModuleMech : ServerModuleBase, ILife
{
    ...
    void On_WeaponDown()
    {
        if (m_Weapon != null)
        {
            ...
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipDie, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Weapon.M_EquipID));
    ...
    {
        m_Weapon = newWeapon;
        ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipEquiped, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Weapon.M_EquipID));
    ...
    void On_ShieldDown()
    {
        if (m_Shield != null)
        {
            ...
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipDie, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Shield.M_EquipID));
    ...
    {
        m_Shield = newShield;
        ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipEquiped, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Shield.M_EquipID));
    ...
    void On_PackDown()
    {
        if (m_Pack != null)
        {
            ...
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipDie, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Pack.M_EquipID));
    ...
    {
        m_Pack = newPack;
        ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipEquiped, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_Pack.M_EquipID));
    ...
    void On_MADown()
    {
        if (m_MA != null)
        {
            ...
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipDie, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_MA.M_EquipID));
    ...
    {
        m_MA = newMA;
        ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnEquipEquiped, new ExecutorInfo(ServerPlayer.ClientId, M_MechID, equipId: m_MA.M_EquipID));
    ...
    public bool CanAttack
    {
        ...
        set
        {
            if (canAttack && !value)
            {
                ServerPlayer.MyBattleGroundManager.CanAttackMechs.Remove(M_MechID);
            }

            if (!canAttack && value)
            {
                ServerPlayer.MyBattleGroundManager.CanAttackMechs.Add(M_MechID);
            }
    ...
    public bool CheckMechCanAttackMe(ServerModuleMech attackMech)
    {
        ...
        if (ServerPlayer.MyBattleGroundManager.HasDefenseMech && !IsDefender) return false;
        return true;
    }
    ...
    public bool BeforeAttack(ServerModuleMech targetMech, bool isCounterAttack)
    {
    ...
    public void Attack(ServerModuleMech targetMech, bool isCounterAttack) //服务器客户单分别计算
    {
        int damage = 0;
        ...
        else if (M_MechLeftLife != 0 && targetMech.M_MechLeftLife == 0) //反击方挂了
        {
            ...
            if (CardInfo.MechInfo.IsSoldier) ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierKill, ei);
            else ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroKill, ei);
        }
    ...
    public void OnDieTogether()
    {
        ...
        M_Pack = null;
        M_MA = null;
        ServerPlayer.MyGameManager.AddDieTogetherMechsInfo(M_MechID);
        ExecutorInfo info = new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID);
        if (CardInfo.MechInfo.IsSoldier) ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierDie, info);
        else ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroDie, info);
    }
    ...
    private void OnMakeDamage(int damage)
    {
        ...
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierMakeDamage, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
        else
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroMakeDamage, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
    }
    ...
    private void OnBeDamaged(int i)
    {
        if (CardInfo.MechInfo.IsSoldier)
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierInjured, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
        else
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroInjured, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
    }
    ...
    private void OnBeHealed(int i)
    {
        if (CardInfo.MechInfo.IsSoldier)
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierBeHealed, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
        else
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroBeHealed, new ExecutorInfo(ServerPlayer.ClientId, mechId: M_MechID));
        }
    }
    ...
    private void OnAttack()
    {
        ...
        if (CardInfo.MechInfo.IsSoldier)
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnSoldierAttack, ei);
        }
        else
        {
            ServerPlayer.MyGameManager.EventManager.Invoke(SideEffectExecute.TriggerTime.OnHeroAttack, ei);
        }
    }
