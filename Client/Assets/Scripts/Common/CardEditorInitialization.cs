...
public class CardEditorInitialization : MonoSingleton<CardEditorInitialization>
{
    public bool IsABMode = false;
    [SerializeField] private GameObject Manager;

    private CardEditorInitialization()
    {
    }
    ...
    void Awake()
    {
        ...
        Debug.Log("Start the card editor...");

        UIManager.Instance.ShowUIForms<CardEditorPanel>();
    }
