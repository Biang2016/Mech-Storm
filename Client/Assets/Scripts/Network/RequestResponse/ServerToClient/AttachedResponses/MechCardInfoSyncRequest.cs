...
public class MechCardInfoSyncRequest : ServerRequestBase
{
    ...
    public MechCardInfoSyncRequest()
    {
    }

    public MechCardInfoSyncRequest(int clientId, int instanceId, CardInfo_Base cardInfo)
    {
    ...
    {
        return NetProtocols.SE_MECH_CARDINFO_SYNC;
    }
