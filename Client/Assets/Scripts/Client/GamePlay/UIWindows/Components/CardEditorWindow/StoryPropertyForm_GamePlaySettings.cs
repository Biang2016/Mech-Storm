...
public class StoryPropertyForm_GamePlaySettings : PropertyFormRow
{
    ...
    public void Initialize()
    {
        ...
        PropertyFormRow Row_DrawCardPerRound = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DrawCardPerRoundLabelText", OnDrawCardPerRoundChange, out SetDrawCardPerRound);
        PropertyFormRow Row_DefaultCoin = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultCoinLabelText", OnDefaultCoinChange, out SetDefaultCoin);
        PropertyFormRow Row_DefaultLife = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultLifeLabelText", OnDefaultLifeChange, out SetDefaultLife);
        PropertyFormRow Row_DefaultLifeMax = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultLifeMaxLabelText", OnDefaultLifeMaxChange, out SetDefaultLifeMax);
        PropertyFormRow Row_DefaultLifeMin = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultLifeMinLabelText", OnDefaultLifeMinChange, out SetDefaultLifeMin);
        PropertyFormRow Row_DefaultEnergy = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultEnergyLabelText", OnDefaultEnergyChange, out SetDefaultEnergy);
        PropertyFormRow Row_DefaultEnergyMax = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultEnergyMaxLabelText", OnDefaultEnergyMaxChange, out SetDefaultEnergyMax);
        PropertyFormRow Row_DefaultDrawCardNum = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_DefaultDrawCardNumLabelText", OnDefaultDrawCardNumChange, out SetDefaultDrawCardNum);
        PropertyFormRow Row_MinDrawCardNum = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_MinDrawCardNumLabelText", OnMinDrawCardNumChange, out SetMinDrawCardNum);
        PropertyFormRow Row_MaxDrawCardNum = GeneralizeRow(PropertyFormRow.CardPropertyFormRowType.InputField, "StoryEditorWindow_MaxDrawCardNumLabelText", OnMaxDrawCardNumChange, out SetMaxDrawCardNum);
    }
